...
public class ShowDetailPendingController extends HttpServlet {

    private static final String SUCCESS = "ManagerAssignedTask.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!list.isEmpty()) {
                ...
                session.setAttribute("LIST_DETAIL", list);
                request.setAttribute("CLASS_NAME", "actual-form-row");
                url = SUCCESS;
            }
        } catch (Exception e) {
