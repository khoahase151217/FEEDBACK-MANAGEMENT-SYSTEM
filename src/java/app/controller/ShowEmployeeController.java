 ...
 * @author ASUS
 */
@WebServlet(name = "ShowEmployeeController", urlPatterns = {"/ShowEmployeeController"})
public class ShowEmployeeController extends HttpServlet {

    private static final String ERROR = "##";
    private static final String SUCCESS = "ManagerViewEmployee.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String url = ERROR;
        try {
            ...
            List<UserDTO> list = dao.showEmployeesList();
            if (list != null) {
