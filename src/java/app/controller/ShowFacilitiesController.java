...
public class ShowFacilitiesController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<FacilityDTO> listFacilitiesAvailable = facilitiesDao.getListFacilityAvailableAsc();
            session.setAttribute("FACILTIES_LIST_AVAILABLE", listFacilitiesAvailable);
