 ...
 * @author ASUS
 */
@WebServlet(name = "GetRecentFeedbackForGoodEmpController", urlPatterns = {"/GetRecentFeedbackForGoodEmpController"})
public class GetRecentFeedbackForGoodEmpController extends HttpServlet {
