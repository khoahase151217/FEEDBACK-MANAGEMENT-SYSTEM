 ...
 * @author ASUS
 */
@WebServlet(name = "GetRecentFeedbackForBadEmpController", urlPatterns = {"/GetRecentFeedbackForBadEmpController"})
public class GetRecentFeedbackForBadEmpController extends HttpServlet {
